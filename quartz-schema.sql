...
-- Fuente: Quartz.NET oficial (updated for Quartz 3.x+)

-- Drop existing tables for clean recreation if needed
IF OBJECT_ID('dbo.QRTZ_BLOB_TRIGGERS') IS NOT NULL DROP TABLE dbo.QRTZ_BLOB_TRIGGERS;
IF OBJECT_ID('dbo.QRTZ_SIMPROP_TRIGGERS') IS NOT NULL DROP TABLE dbo.QRTZ_SIMPROP_TRIGGERS;
IF OBJECT_ID('dbo.QRTZ_SIMPLE_TRIGGERS') IS NOT NULL DROP TABLE dbo.QRTZ_SIMPLE_TRIGGERS;
IF OBJECT_ID('dbo.QRTZ_CRON_TRIGGERS') IS NOT NULL DROP TABLE dbo.QRTZ_CRON_TRIGGERS;
IF OBJECT_ID('dbo.QRTZ_TRIGGERS') IS NOT NULL DROP TABLE dbo.QRTZ_TRIGGERS;
IF OBJECT_ID('dbo.QRTZ_SCHEDULER_STATE') IS NOT NULL DROP TABLE dbo.QRTZ_SCHEDULER_STATE;
IF OBJECT_ID('dbo.QRTZ_PAUSED_TRIGGER_GRPS') IS NOT NULL DROP TABLE dbo.QRTZ_PAUSED_TRIGGER_GRPS;
IF OBJECT_ID('dbo.QRTZ_FIRED_TRIGGERS') IS NOT NULL DROP TABLE dbo.QRTZ_FIRED_TRIGGERS;
IF OBJECT_ID('dbo.QRTZ_LOCKS') IS NOT NULL DROP TABLE dbo.QRTZ_LOCKS;
IF OBJECT_ID('dbo.QRTZ_JOB_DETAILS') IS NOT NULL DROP TABLE dbo.QRTZ_JOB_DETAILS;
IF OBJECT_ID('dbo.QRTZ_CALENDARS') IS NOT NULL DROP TABLE dbo.QRTZ_CALENDARS;
GO

-- Tables don't exist, create fresh schema
...
ALTER TABLE [dbo].[QRTZ_BLOB_TRIGGERS] ADD CONSTRAINT [FK_QRTZ_BLOB_TRIGGERS_QRTZ_TRIGGERS] FOREIGN KEY ([SCHED_NAME], [TRIGGER_NAME], [TRIGGER_GROUP]) REFERENCES [dbo].[QRTZ_TRIGGERS]([SCHED_NAME], [TRIGGER_NAME], [TRIGGER_GROUP]) ON DELETE CASCADE;
GO
